...
const App = () => {
  const [screen, setScreen] = useState<'today' | 'mypage'>('today');
        ...
        {screen === 'today' ? (
          <>
            ...
            <View style={styles.fastingInfo}>
              <Text style={styles.fastingLabel}>You are fasting</Text>
              <View style={styles.timerTextOverlay}>
                  <Text style={styles.timer}>4:10:20</Text>
                  <Text style={styles.endTime}>End time 12:30</Text>
              </View>
            </View>
            <View style={styles.timerCircle}>
              ...
              <View style={styles.timerCircleWrapper}>
                ...
                {/* 進捗円の180度反対側（下部）にも宝箱アイコンを重ねる */}
                <View style={{ position: 'absolute', top: timerCircleSize - 30, left: timerCircleSize / 2 - 24, zIndex: 10 }}>
                  <RewardIcon width={48} height={42} />
                </View>
                <Svg width={timerCircleSize} height={timerCircleSize}>
                  ...
                  <Circle
                    ...
                    strokeWidth={24}
                    fill="none"
                    strokeDasharray={2 * Math.PI * ((timerCircleSize / 2) - 12)}
                    strokeDashoffset={2 * Math.PI * ((timerCircleSize / 2) - 12) * 0.3}
                    strokeLinecap="round"
                    rotation="-90"
                ...
                <View style={[styles.timerTextOverlay, { width: timerCircleSize, height: timerCircleSize, position: 'absolute', top: 100, left: 0 }] }>
                  ...
                  <View style={{ position: 'absolute', top: 0, right: timerCircleSize / 6 - 90, zIndex: 10 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginTop: -15 }}>
                      <Text style={[styles.goalText, { textAlign: 'center'}]}><Text style={{fontWeight: 'bold', fontSize: 20}}>8,312 / 10,000</Text> steps done</Text>
                    </View>
                  </View>
                </View>
              </View>
            ...
            {/* End Fastingボタン */}
            <TouchableOpacity style={styles.endFastingButton}>
